<template>
  <!-- 对话框 -->
  <transition name="m-dialog-fade">
    <div class="m-dialog-box" v-show="dialogShow">
      <div class="m-dialog-wrapper">
        <div class="m-dialog-content">
          ...
          <div class="m-dialog-btns">
            ...
            <slot name="btn"></slot>
            <div class="m-btn-confirm" v-text="confirmText" @click="confirm"></div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  destroyed() {
    if(appendToBody && this.$el && this.$el.parentNode) {
